...
| `certificate-repair-check` | check a repair: the parent defect, the candidate proof, the inherited contract | 3 | 5 | 0 | 4 |
| `certificate-repair-pack` | package a refutation and a candidate certificate as an unchecked repair | 1 | 2 | 0 | 3 |
