...
Build 45 anchors it as a fourth closure, **Projection checker**, and gives the
launcher a `--projection` mode, so the launcher digest changes for every row of
`checker-ab72a8025a56`. Those rows were never tagged; they are updated in place, as
`checker-b4eee031f709` was. The label stays because the machine proof checker does not
change. A label derived from one digest cannot tell apart two snapshots that share a
machine checker: once `checker-ab72a8025a56` is tagged, a later launcher or
projection-checker change has no free label. That rule is an open decision.
...
| `checker-ab72a8025a56` | Machine proof checker | `ab72a8025a564c067f6d3a8551775733a8153ef696d1942a1f1b80e4afe107cd` | `7e2b854bb2a84419a1d69ef0d54c76e258a5b609a3acdb943b27607e31d0be75` |
| `checker-ab72a8025a56` | Boolean lab runtime | `cb9d30cea2b59ca84e96af10aedf0ea81df35fa5eccc22c3f24dd2d313ab4e35` | `7e2b854bb2a84419a1d69ef0d54c76e258a5b609a3acdb943b27607e31d0be75` |
| `checker-ab72a8025a56` | Experiment controller | `8acd80175b60ed4e4cc2646cdb95ea2ff245e7fbc0f01208388947ae6cfe89c4` | `7e2b854bb2a84419a1d69ef0d54c76e258a5b609a3acdb943b27607e31d0be75` |
| `checker-ab72a8025a56` | Projection checker | `392c11b3683dc1e9d93d708c46012600503c3ea495aaa666221d5e27cc20e4a4` | `7e2b854bb2a84419a1d69ef0d54c76e258a5b609a3acdb943b27607e31d0be75` |
...
their names. CI recomputes all five digests on every push and pull request and
