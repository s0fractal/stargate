...
Build 39 adds a local executor outside the closures below; all four anchors remain
identical to build-38. It is an untagged PR candidate, not a published checkpoint.
