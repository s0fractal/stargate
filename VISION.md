...
кандидатові як контрприклад. Незавершене обчислення не зараховується як збіг. Якщо мета — оптимізація, контракт
...
обох програм, а контроль із навмисно зламаним lowering має виявити
розбіжність. Згода двох реалізацій посилює перевірку, але не усуває
