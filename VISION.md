...
Різниця дає конкретне призначення-контрприклад. Лише завершений повний
перебір дозволяє стверджувати еквівалентність у цьому домені. Незавершене
обчислення не зараховується як збіг. Якщо мета — оптимізація, контракт
...
кандидат відхиляється з відтворюваним контрприкладом. Це ще не реалізовано.
