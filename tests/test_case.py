...
class Case(unittest.TestCase):
    ...
    def test_cli_pack_inspect_unpack_and_refusals(self):
        ...
        self.assertEqual(self.cli('case-inspect', packed)[0], 0)
        out = self.root/'materialized'
        self.assertEqual(self.cli('case-unpack', packed, '--output', out)[0], 0)
        self.assertEqual(self.cli('case-unpack', packed, '--output', out)[0], 1)
        self.assertEqual(self.cli('case-inspect', self.root/'absent')[0], 3)
        packed.write_bytes(b'{}')
        self.assertEqual(self.cli('case-inspect', packed)[0], 2)
